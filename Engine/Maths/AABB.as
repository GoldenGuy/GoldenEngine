...
class AABB
{
    ...
    AABB opMul(float oof) { return AABB(min * oof, max * oof); }
    AABB opDiv(float oof) { return AABB(min / oof, max / oof); }

    AABB opMul(Vec3f oof) { return AABB(min * oof, max * oof); }
    AABB opDiv(Vec3f oof) { return AABB(min / oof, max / oof); }
